...
This prints the number 1 to 20, each on a separate line.
 
### Exercise 2

Here, I will print 10 random numbers from uniform distribution.

```{r ex2}

# Draw 10 draes from a uniform distribution
runif(10)

```

This drew 10 random numbers from uniform distribution.This completes the second exercise.
